...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\City tech\Desktop\Project Cyber\frame\frame0")

from tkinter import Tk, Canvas, Entry, Button, PhotoImage, filedialog, messagebox
home= r"C:\Users\krkr\Desktop\TERM4\cyper-security\EN_DE_criptionGui\Project Cyber\HomePage\gui.py" 
def home1():
    window.destroy()
...
def decrypt_text(ciphertext, key):
  ...
  for char in ciphertext:
    if char.isalpha():
      ascii_offset = ord('A') if char.isupper() else ord('a')
      decrypted_char = chr((ord(char) - ascii_offset + 26 - key) % 26 + ascii_offset)
